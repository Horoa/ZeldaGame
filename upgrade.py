...
class Upgrade:
    def __init__(self, player):
        ...
        self.width = self.display_surface.get_size()[0] // self.attribute_number
        self.create_items()
    ...
    def input(self):
        ...
        if self.can_move:
            if keys[pygame.K_RIGHT]:
                ...
                self.selection_index %= self.attribute_number
                self.can_move = False
    ...
    def create_items(self):
        ...
        for item, index in enumerate(range(self.attribute_number)):
            ...
            new_item = Item(left, top, self.width, self.height, index, self.font)
...
class Item:
    ...
    def trigger(self, player):
        ...
        if player.exp >= player.upgrade_cost[upgrade_attribute] and player.stats[upgrade_attribute] < player.max_stats[upgrade_attribute]:
            ...
            player.stats[upgrade_attribute] = min(player.stats[upgrade_attribute]*1.2, player.max_stats[upgrade_attribute])
